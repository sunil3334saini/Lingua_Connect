    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-center mb-8">
          Login to your Lingua Connect account
        </p>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-white pr-10"
                placeholder="••••••"
              />
              <button
                type="button"
